        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <?php 
                            ...
                            $feedback="SELECT * from students WHERE status = 'Graduated' AND Course = 'Cookery' ORDER BY studentid DESC  LIMIT 10 ";
                            if ($result=mysqli_query($con,$feedback))
                            {
                            // Return the number of rows in result set
                            $rows=mysqli_num_rows($result);
                            echo "<b style = 'color: green'> Graduates Cookery Students = ". $rows. " ". "</b>";
                            // Free result set
                            mysqli_free_result($result);
                            } ?>
...
<table class="table table-striped table-dark">
  ...
  <?php
       ...
       $feedback="SELECT * from students WHERE status = 'Graduated' AND Course = 'Cookery' ";
