        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <?php 
                            ...
                            $feedback="SELECT * from students WHERE campus = 'Nairobi' AND status = 'Graduates' ";
                            if ($result=mysqli_query($con,$feedback))
                            {
                            // Return the number of rows in result set
                            $rows=mysqli_num_rows($result);
...
<div class="row">
  ...
  <div class="col-sm-7">
    ...
    <?php
                               ...
                               $qrt='SELECT * from users WHERE message_from ="Kitui" OR message_from ="Machakos"  and status = "Unread" ORDER BY id DESC  LIMIT 3';
